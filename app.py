...
#     keywords = [
#         "diet", "nutrition", "calorie", "vitamin", "mineral", "protein", 
...
# st.markdown("""
# <ul>
# <li><span class="bullet-title">Enter Your Query:</span> Enter your question or concern about nutrition into the input box.</li>
    ...
    if not user_input.strip():
        ...
        with st.spinner("Generating recommendation..."):
            ...
            if recommendation:
                ...
                st.info("Can't find any diet plan based on the provided input. Please try again with a different query.")
        # Clear the input field after getting the recommendation
        st.session_state.user_input = ""
